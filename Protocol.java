...
public class Protocol {
    ...
    public static boolean isProtocolValid(int protocol) {
        return (protocol == PING_PKT || protocol == PING_REPLY_PKT || protocol == LINK_INFO_PKT || protocol == NAME_PKT
     ...
     * @return The string representation of the given protocol. "Unknown Protocol"

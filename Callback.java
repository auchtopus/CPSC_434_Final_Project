...
public class Callback {
     ...
     * @param params An array of objects to be passed to the method as parameters
     ...
     * 
     * @param params The params to be passed to the method when it is invoked
     */
     ...
     * 
     * @throws IllegalAccessException    Thrown by invoke method in class Method
     * @throws InvocationTargetException Thrown by invoke method in class Method, if
     ...
     * 
     * @param methodName The name of the method that we want a Method object for
     * @param obj        The object that owns the method
     * @return A Method object which can be passed to the constructor of this class
     * @param parameterTypes Array of strings of parameter type names. Can be null
     *                       if there are no parameter types
     * @throws ClassNotFoundException This exception is thrown by Class.forName if
     *                                the given class name does not exist
     * @throws NoSuchMethodException  Thrown by Class.getMethod if a matching method
     *                                is not found
     * @throws SecurityException      Thrown by Class.getMethod if access to the
     *                                information is denied
     */
    public static Method getMethod(String methodName, Object obj, String[] parameterTypes)
